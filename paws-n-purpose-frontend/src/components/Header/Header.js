...
export default function Header({withColor, isLoggedIn}) {
  return (
    <div 
      className="header"
      style={withColor ? { backgroundColor: "#78B96C" } : { backgroundColor: "transparent" }}
    >
      <div 
        className="inner-layer"
        style={withColor ? { backgroundColor: "#ffff" } : { backgroundColor: "transparent" }}
      >
        { isLoggedIn ? 
          <>
            <div 
            ...
            >
              <div className="nav-button-icon-container messages">
                <svg className="nav-button-icon" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div
                className="nav-button-icon-container notifs"
                style={{
                  marginRight: "0.8rem"
                }}
              >
